  ...
  //         headers: {
  //           // If you have a token, include it here:
  //           Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NSwiaWF0IjoxNzUzNjA3NzI2LCJleHAiOjE3NTQyMTI1MjZ9.GYFwkfBp7s1APAxcuRzwA0IP8IluZ_6fskVVTWXn-bE`
  //         }
  //       });
  ...
  //       // Comments are usually inside article.comments, but adjust according to your API response
  //       setArticle(articleData);
  //       setComments(articleData.comments || []); // or however your backend returns comments
  //     } catch (err) {
